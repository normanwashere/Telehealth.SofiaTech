        ...
        <section className="animate-fade-in py-16 md:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-screen-2xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
                    {/* Pillar 1 */}
                    <div 
                        className="glass glass-hover p-8 rounded-3xl border border-emerald-500/20 relative group cursor-pointer overflow-hidden flex flex-col"
                    ...
                    {/* Pillar 2 */}
                    <div 
                        className="glass glass-hover p-8 rounded-3xl border border-orange-500/20 relative group cursor-pointer overflow-hidden flex flex-col"
                    ...
                    {/* Pillar 3 */}
                    <div 
                        className="glass glass-hover p-8 rounded-3xl border border-sky-500/20 relative group cursor-pointer overflow-hidden flex flex-col"
