        ...
        <section className="animate-fade-in py-16 md:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="w-full max-w-screen-2xl mx-auto space-y-24 relative z-10">
                ...
                <div>
                    ...
                    <div className="glass rounded-3xl p-6 md:p-8 mb-12 border border-slate-700/50 shadow-xl">
                        {loading ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1">Province/City</label>
                                    <div className="relative">
                                        <select 
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1">Municipality</label>
                                    <div className="relative">
                                        <select 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        <div className="glass p-6 rounded-3xl border border-slate-700/50 flex flex-col min-h-[450px] relative overflow-hidden group">
                        ...
                        <div className="glass p-6 rounded-3xl border border-slate-700/50 flex flex-col min-h-[450px] relative overflow-hidden group">
                            ...
                            <div className="flex-grow relative z-10">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart>
                                        <Pie data={chartData.gen} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} paddingAngle={5}>
                        ...
                        <div className="glass p-6 rounded-3xl border border-slate-700/50 flex flex-col min-h-[450px] relative overflow-hidden group md:col-span-2 xl:col-span-1">
                             <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                             ...
                             <div className="flex-grow relative z-10">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart>
                                        <Pie data={chartData.sex} dataKey="value" nameKey="name" cx="50%" cy="50%" startAngle={180} endAngle={0} innerRadius={80} outerRadius={120} paddingAngle={2}>
                ...
                <div>
                    <div className="text-center mb-10">
                        ...
                        <div className="inline-flex bg-slate-900/80 p-1 rounded-xl border border-slate-700/50 relative">
                            <button 
                                ...
                                className={`relative px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 z-10 ${
                                    planType === 'individual' ? 'text-white shadow-lg' : 'text-slate-400 hover:text-slate-200'
                                }`}
                            >
                                Individual Coverage
                            </button>
                            <button 
                                ...
                                className={`relative px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 z-10 ${
                                    planType === 'family' ? 'text-white shadow-lg' : 'text-slate-400 hover:text-slate-200'
                                }`}
                            >
                                Family Care Bundle
                            </button>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                        ...
                        <div className="glass rounded-3xl p-8 border border-emerald-500/30 relative overflow-hidden flex flex-col">
                        ...
                        <div className="glass rounded-3xl p-8 border border-slate-700/50 flex flex-col relative overflow-hidden">
                             {/* Decorative Top Line */}
                             ...
                             <div className="mb-8">
                                ...
                                <div className="flex gap-4 mb-6 cursor-pointer hover:opacity-90 transition-opacity" onClick={() => setActiveDetailModal('value')}>
                                    ...
                                    <div className="flex-1 bg-slate-950 p-4 rounded-2xl border border-slate-800 relative overflow-hidden group">
                                        ...
                                        <span className="text-[10px] text-emerald-500/80 uppercase font-bold tracking-widest block mb-1">
                            ...
                            <div className="flex-grow space-y-4">
                                ...
                                >
                                    <div className="grid grid-cols-3 bg-slate-900 p-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">
                                        ...
                                        {[
                                            ...
                                            <div key={i} className="grid grid-cols-3 p-4 hover:bg-slate-900/50 transition-colors items-center group">
                                                <div className="text-slate-300 font-bold pl-2">
                                                    {item.label} <br/>
                                                    <span className="text-[10px] text-slate-500 font-medium uppercase tracking-wide group-hover:text-slate-400 transition-colors">{item.sub}</span>
                                                </div>
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            {priceOverride !== null && (
                                                <button 
                                                    ...
                                                    className="text-[10px] text-amber-400 hover:text-amber-300 uppercase font-bold tracking-wider mt-1 text-left"
                                                >
                                                    Reset to Tier
                                                </button>
                                            )}
