            ...
            <div className="max-w-screen-2xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
                    {challenges.map((item) => (
                        <div 
                            key={item.id}
                            className="group relative rounded-3xl overflow-hidden cursor-pointer h-96 transition-all duration-500 hover:scale-[1.02] shadow-2xl border border-white/5"
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-8 flex flex-col justify-end">
                                ...
                                <h3 className="text-3xl font-bold text-white mb-1 leading-tight group-hover:translate-x-2 transition-transform duration-300">{item.title}</h3>
                                <p className={`text-lg font-bold text-${item.color}-400 mb-3 uppercase tracking-widest group-hover:translate-x-2 transition-transform duration-300 delay-75`}>{item.subtitle}</p>
